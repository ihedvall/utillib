 ...
 *
 * The file implements amn interface against the listen configuration shared
 * memory. This memory is shared among all application a specific computer. It
 * is created by the listen daemon application which must be running.
 */
#pragma once
#include <cstdint>
#include <string>
