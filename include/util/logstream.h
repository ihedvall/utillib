...
/** \file logstream.h
 * \brief Implements a stream interface to log messages. This is the file to use in most applications.
 * The LOG_INFO() and the LOG_ERROR() macros is wrap around the location calls.
 */
#pragma once
#include <string>
#include <sstream>
 ...
 *
 * The class implements a stream interface around a log message. You should not uss this class directly.
 * Instead use the LOG_INFO() and LOG_ERROR() macro instead.
 *
 * Usage:
 * \code
